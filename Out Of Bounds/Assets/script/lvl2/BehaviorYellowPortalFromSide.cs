...
Behavior of the yellow portal. It makes the Hero goes at the exit portal position which is -90° from the enter position.
The hero come by a side.
       __        enter        
		'
    	'----|   exit
*/
...
public class BehaviorYellowPortalFromSide : MonoBehaviour {
	...
	void OnTriggerEnter2D(Collider2D rigid){
		...
		case 1 : //gravity down
			...
			rigid.gameObject.rigidbody2D.velocity = new Vector2(0f,playerVelX);
